import {createRetrofuturism} from './spline/retrofuturism/backdrop.js?v=fast-load-43';
...
import('./live-tour-glass.js?v=motion-24').then(m=>{attachLiveTourGlass=m.attachLiveTourGlass;syncSearch()});
